...
<br><br>
<center>
<h3>Upload Product</h3><br><br>
<c:url var="insertproduct" value="insertproduct.html"/>
<form:form modelAttribute="product" method="post" enctype="multipart/form-data" action="${insertproduct}">
...
<tr>
<td>Product Type</td>
<td><form:select path="type" items="${model.ptype}"></form:select></td>
</tr>
<tr>
<td>Description</td>
...
<tr>
<td>User Type</td>
<td><form:select path="usertype" items="${model.utype}"></form:select></td>
</tr>
<tr>
<td>Price</td>
