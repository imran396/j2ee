...
<div id="header">
	...
	<c:choose> 
			<c:when test="${type == null}">
				<li class="first_list"><a style="color:black" href="brandlist.html" class="main_menu_first">Registration</a></li>
...
<div style="color: teal;font-size: 30px">User List</div>
<br><br>
...
<br>
<a href="adminregister.html" >Add new Admin</a>
<br><br>
<a href="brandregister.html" >Add new Brand</a><br><br>
<a href="brandlist.html" >BrandList</a><br><br>

<a href="adminviewbrand.html" >ProductList</a><br><br>
</center>
