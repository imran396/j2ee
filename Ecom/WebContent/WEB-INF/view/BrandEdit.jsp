...
<br><br>
<form:form method="post" action="brandedit.html" commandName="editbrand" enctype="multipart/form-data">
    <form:hidden path="id"/> 
<table width="400px" height="150px">
<tr>
<td><form:label path="name">Brand Name</form:label></td>
<td><form:input  path="name"/></td>
</tr>
<tr>
<td><form:label path="logo">Logo</form:label></td>
<td><form:input path="logo" id="logo" type="file" /></td>
</tr>
<tr>
...
<tr>
<td><form:label path="outlet">Outlet</form:label></td>
<td><form:input  path="outlet"/></td>
</tr>
<tr>
